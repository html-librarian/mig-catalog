...
class ArticleService:
    ...
    def get_articles(self, skip: int  =  0, limit: int  =  100, published_only: bool  =  True) -> List[Article]:
    ...
    def get_article(self, article_uuid: str) -> Optional[Article]:
        ...
        return self.db.query(Article).filter(Article.uuid == article_uuid).first()
    ...
    def update_article(self, article_uuid: str, article_update: ArticleUpdate) -> Optional[Article]:
        """Обновить статью"""
    ...
    def search_articles(self, search_term: str, skip: int  =  0, limit: int  =  100) -> List[Article]:
